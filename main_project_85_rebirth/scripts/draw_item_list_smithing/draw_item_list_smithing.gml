...
else //if the item has been chosen
{
    ...
    {
    case 0: material_amount = 0; break;
    case 2: resource_1_amount = 0; break;
    case 3: resource_2_amount = 0; break;
    }
    ...
    */
    if a_pressed
    {
        ...
        switch(crafting_menu_controller.selection)
        {
            case 0: material_id = display_array[list_item_selected];
            material_amount = list_item_amount; 
            crafting_menu_controller.material_list_selected = list_item_selected;
            switch (material_id)
            {
            case 1: item_to_be_crafted = 23; item_to_be_crafted_level = clamp(list_item_amount,0,10); break;
            case 2: item_to_be_crafted = 18; item_to_be_crafted_level = clamp(list_item_amount,0,10); break;
            case 5: item_to_be_crafted = 17; item_to_be_crafted_level = clamp(list_item_amount,0,10); break;
            case 9: item_to_be_crafted = 16; item_to_be_crafted_level = clamp(list_item_amount,0,10); break;            
            case 10: item_to_be_crafted = 22; item_to_be_crafted_level = clamp(list_item_amount,0,10); break;
            case 11: item_to_be_crafted = 20; item_to_be_crafted_level = clamp(list_item_amount,0,10); break;
            case 12: item_to_be_crafted = 19; item_to_be_crafted_level = clamp(list_item_amount,0,10); break;
            case 13: item_to_be_crafted = 24; item_to_be_crafted_level = clamp(list_item_amount,0,10); break;
            case 15: item_to_be_crafted = 21; item_to_be_crafted_level = clamp(list_item_amount,0,10); break;            
            ...
            crafting_menu_controller.resource_1_list_selected = list_item_selected;
            break;
            ...
            crafting_menu_controller.resource_2_list_selected = list_item_selected;
            break;
        }
        list_item_amount = 0;
        list_item_is_chosen = false;
